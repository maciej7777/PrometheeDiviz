 ...
 */
public class PlotClassAssignmentCLI {

    private PlotClassAssignmentCLI() {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        {
            PlotClassAssignmentXMCDAv2.main((String[]) argsList.toArray(new String[]{}));
        }
        else if ( argsList.remove("--v3") )
        {
            PlotClassAssignmentXMCDAv3.main((String[]) argsList.toArray(new String[]{}));
        }
        else
        {
